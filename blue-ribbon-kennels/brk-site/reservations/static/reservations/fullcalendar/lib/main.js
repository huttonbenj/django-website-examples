    ...
    var PointerDragging = /** @class */ (function () {
        function PointerDragging(containerEl) {
            ...
            this.isIgnoredType = function isIgnoredType() {
                ...
                if(document.getElementsByClassName('additional-days-active').length){
                    return false;
                }
            ...
            this.handleMouseDown = function (ev) {
                ...
                if ((_this.customIsDragging || _this.isIgnoredType()) && !pastDate){
                ...
                if (!_this.shouldIgnoreMouse() &&
                    ...
                    // only add mousemove listener if its not an ignored type
                    if (!_this.isIgnoredType()){
                        if (!_this.shouldIgnoreMove && !pastDate) {
