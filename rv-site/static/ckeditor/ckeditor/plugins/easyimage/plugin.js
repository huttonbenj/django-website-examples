...
( function() {
	...
	CKEDITOR.plugins.add( 'easyimage', {
		...
		icons: 'easyimagefull,easyimageside,easyimagealt,easyimagealignleft,easyimagealigncenter,easyimagealignright,easyimageupload,easyimageupload2', // %REMOVE_LINE_CORE%
