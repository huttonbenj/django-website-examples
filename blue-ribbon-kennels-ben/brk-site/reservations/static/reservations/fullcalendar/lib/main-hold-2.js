    ...
    */
    var PointerDragging = /** @class */ (function () {
        function PointerDragging(containerEl) {
            ...
            this.customDragStarted = false;
            
            // I ADDED
            this.isIgnoredType = function isIgnoredType() {
                let reservationType = document.querySelector('.btn-check.valid').value;
                let ingoreTypes = ['obedience_training', 'retriever_training'];
                return ingoreTypes.includes(reservationType);
            }
            // END OF I ADDED
            ...
            this.handleMouseDown = function (ev) {
                let pastDate = ev.target.closest('.fc-day-past');

                // I ADDED
                if ((_this.customDragStarted || _this.isIgnoredType()) && !pastDate){
                    document.removeEventListener('mousemove', _this.handleMouseMove);
                    _this.emitter.trigger('pointerup', _this.createEventFromMouse(ev));
                } else if (pastDate){
                       
                    let errorMsgWrapper = document.createElement('div');
                    let errorMsgContainer = document.createElement('div');
                    
                    errorMsgWrapper.className = 'style-msg errormsg text-center';
                    errorMsgContainer.className = 'sb-msg';
                    errorMsgContainer.innerHTML = '<strong>Error: </strong>You must select a current or future date (not a past date).';
                     
                    errorMsgWrapper.append(errorMsgContainer);

                    let errorMsgs = document.querySelector('.errormsg');
                    if (!errorMsgs){
                        document.getElementById('calendar').append(errorMsgWrapper)
                ...
                if (!_this.shouldIgnoreMouse() &&
                    ...
                    // I ADDED
                    if (!pastDate){
                        // THIS EXISTED -- I JUST WRAPPED IN IF
                ...
                // I ADDED (set this on first mouse down)
                if (!pastDate) {

                _this.customDragStarted = true;
                }
                // END OF I ADDED
            ...
            this.handleMouseMove = function (ev) {
                ...
                if (!pastDate){
                    ...
                    // I ADDED 
                    if (!_this.isIgnoredType() && !pastDate){
                        if (!_this.isDragging){
            ...
            //     // I ADDED
            //     if (_this.isIgnoredType()){
            //         _this.emitter.trigger('touchend', _this.createEventFromMouse(ev));
            //     }
            //     // END OF I ADDED
