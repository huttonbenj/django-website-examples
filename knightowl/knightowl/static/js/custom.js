...
if($contact.length){
  ...
  if($pricing.length){
    $("button").click(function() {
      var back_clicked = $(this).attr('id');
      window.location.href = "https://knightowl-studios.com";
    });


    $("input").click(function() {
      var submit_clicked = $(this).attr('id');
      if(submit_clicked == "submit"){
        $pricing.validate({  //#contact-form contact form id
          rules: {
            first_name: {
              required: true    // Field name here
            },
          ...
          messages: {
                    ...
                    from_email: "Please enter valid Email", //Write here your error message that you want to show in contact form
                    message: "Please write your Message" //Write here your error message that you want to show in contact form
                },
