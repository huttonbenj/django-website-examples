...
def pre_save_lots(sender, instance, **kwargs):
    if instance.description == None:
        instance.description = ''

@receiver(post_save, sender=PageTitle)
def post_save_pt_lots(sender, instance, created, **kwargs):
    if created:
        Seo(page_title=instance).save()


@receiver(pre_save, sender=Seo)
def pre_save_seo_lots(sender, instance, **kwargs):
