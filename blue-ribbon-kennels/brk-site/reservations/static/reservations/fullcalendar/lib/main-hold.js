    ...
    var PointerDragging = /** @class */ (function () {
        function PointerDragging(containerEl) {
            ...
            this.handleMouseDown = function (ev) {
                if (!document.querySelector('.fc-not-allowed')) {
                    if(ev.target.className.includes('fc-daygrid') || ev.target.className.includes('fc-highlight')) {
                        if (document.querySelector('.user-selection-started')) {
                            document.querySelector('.user-selection-started').classList.replace('user-selection-started', 'user-selection-ended')
                        }
                    } 
                }
                ...
                if (!_this.shouldIgnoreMouse() &&
                    ...
                    if (!pev.origEvent.target.className.includes('disabled') || !document.querySelector('.fc-not-allowed')) {
            ...
            this.handleMouseUp = function (ev) {
                if (!document.querySelector('.fc-not-allowed')) {
                    if(ev.target.className.includes('fc-daygrid') || ev.target.className.includes('fc-highlight')) {
                        if (!document.querySelector('.user-selection-started') && !document.querySelector('.user-selection-ended') && containerEl!=document) {
                            containerEl.classList.add('user-selection-started');
                        }
                        if (document.querySelector('.user-selection-ended')) {
